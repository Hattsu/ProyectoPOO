...
{
    class Pasteles:Postres, IServicio
    {
        public Pasteles(string sabor, string nombre, int cantidad, double precio, string tamaño): base (sabor, nombre, cantidad, precio, tamaño)
        {
        }
        /*public abstract function Panel_opciones_inicio();
        public abstract function Cambios_opciones(string Numero_opcion);
        public abstract function Cancelar_pedido();
        public abstract function Verificar_pedido();
        public abstract function Menu_inicio();*/
